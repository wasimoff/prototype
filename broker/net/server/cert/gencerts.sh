...
#
# NOTE: I've added functionality to the broker itself to generate these on-the-fly
# and return the correct certificate hash on a HTTP route, so for a localhost
# deployment you shouldn't need to generate your own certificate. For a public
# installation you should use a properly trusted certificate, e.g. from LetsEncrypt
# anyway.
